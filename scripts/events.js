...
const generateEventPage = async (eventData, eventId, time, size) => { 
    ...
    if (eventId === "GdyQq9KCK5WAJTWRZfgV"){ 
        ...
        /* Weekly Change */ 
        if ((eventData.week === 1 || eventData.week === 2 || eventData.week === 3 || eventData.week === 4 || eventData.week === 5 || eventData.week === 6 || eventData.week === 7 || eventData.week === 8) && (eventData.month > "03" || eventData.month == "01") || (eventData.month == "02" && (eventData.week == 5 || eventData.week == 6))){
            loginStyle = 'display: none;';
            reserveStyle = 'display: none;';
            soldOutStyle = 'display:none';
